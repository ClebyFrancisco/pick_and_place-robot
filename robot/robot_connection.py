...
class RobotConnection:
    ...
    def create_tcp_connection(ip: str = "192.168.2.10",
                              ...
                              password: str = "admin"):
        """
        :returns: A RobotConnection instance, required to create
    ...
    def disconnect(self):
        ...
        # TODO - Criar classe que vai lidar o gerenciamento de devices.
        #  Removendo-os como atributos de classe.
...
if __name__ == "__main__":
    robot_connection = RobotConnection("192.168.2.10")
